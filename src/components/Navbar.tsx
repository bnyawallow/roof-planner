      ...
      <div className="flex justify-between items-center w-full px-6 h-full max-w-screen-2xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a 
            ...
            className="font-headline font-semibold tracking-tight transition-all px-4 py-2 rounded-sm relative text-on-surface-variant hover:bg-surface-container-low"
          >
            3D Visualizer
          </a>
          <a 
            href="https://pinnacle.creativefringe.digital"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="flex items-center gap-4">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="hidden md:flex items-center gap-2 bg-whatsapp-green text-white px-4 py-2 rounded-sm font-bold text-sm font-sans transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:bg-[#20bd5a] active:scale-95">
